...
- A **process** declares a visible material transformation, category, base cycle time, optional reusable tooling and setup group, optional inspection/rework behavior, and an optional tracked-lot termination boundary; a blueprint binds it to a compatible Device.
