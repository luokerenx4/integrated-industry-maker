...
- A **process** declares a visible material transformation, category, base cycle time, optional reusable tooling and setup group, and optional inspection or rework behavior; a blueprint binds it to a compatible Device.
