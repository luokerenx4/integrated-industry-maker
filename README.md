...
The suite covers isolated projects, global/spatial production optimization, cyclic and multi-input recipes, finite resources, physical and station logistics, fuel generation, deterministic accumulator charging/discharging, exact depletion boundaries, power-paused job resumption, typed asset runtimes, immutable replay, CLI evaluation, and renderer-independent Studio projection.
