...
→ explicit sorter-span and cardinal transport-path validation, shared-cell graph compilation, loader/line/unloader throughput, and integer travel time
