...
4. Both metric snapshots come from the ordinary deterministic simulator and evaluator. The delta is always `to - from` for score, throughput, attainment, energy, transport energy, build cost, area, WIP, belt blockage/utilization, and congestion.
