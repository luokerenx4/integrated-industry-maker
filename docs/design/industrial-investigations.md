...
Status: V8 resumable Investigation Design Session over continuous factory observation, source-pinned Candidate and Production-Plan authoring, exact review/TRIAL/comparison/disposition identity, and one-variable immutable Run-comparison checkpoints in Core, `inm`, Studio, and the memory-fab north-star fixture.
