...
- optional compatible-run tracked-lot loss attribution with exact run identity, outcome, primary signal, ranked chain, named buckets, ordered input-gap Device and Q-time step/Device contributors, and interpretation caveat;
