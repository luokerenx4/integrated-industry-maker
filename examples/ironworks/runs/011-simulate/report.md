# INM Run 011-simulate

- Decision: **BASELINE**
- Blueprint: `main`
- Score: **9.923**
- Result hash: `7fc1ab5da3c9aa197c2dabe2a72bf604def7ae9f84428352ca7b922ce999ea34`
...
- Inventory accounting: 5.832 average scored WIP / 56.294 total inventory · 10.000 peak WIP / 68.000 peak total
...
| --- | --- | ---: | ---: | ---: |
| iron-plate | WIP | 5.832 | 10.000 | 7.000 |
| coal | excluded | 35.556 | 41.000 | 39.000 |
| iron-ore | excluded | 14.831 | 18.000 | 18.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: |
| buffer:station-supply:storage:iron-plate | iron-plate | buffer | station-supply.storage | 2.315 | 6.000 | 1.000 |
| station-transit:inter-zone-main:inter-zone-main%3Airon-plate%3Astation-supply-%3Estation-demand:iron-plate | iron-plate | station-transit | inter-zone-main.inter-zone-main:iron-plate:station-supply->station-demand | 1.998 | 6.000 | 6.000 |
| buffer:assembler-1:input-primary:iron-plate | iron-plate | buffer | assembler-1.input-primary | 0.697 | 4.000 | 0.000 |
| in-process:assembler-1:assemble-gear:iron-plate | iron-plate | in-process | assembler-1.assemble-gear | 0.450 | 2.000 | 0.000 |
| buffer:station-demand:storage:iron-plate | iron-plate | buffer | station-demand.storage | 0.071 | 5.000 | 0.000 |
| local-transit:plate-to-station:belt:iron-plate | iron-plate | local-transit | plate-to-station.belt | 0.063 | 1.000 | 0.000 |
| local-transit:plate-to-station:unloading:iron-plate | iron-plate | local-transit | plate-to-station.unloading | 0.059 | 1.000 | 0.000 |
| local-transit:plate-to-station:loading:iron-plate | iron-plate | local-transit | plate-to-station.loading | 0.059 | 1.000 | 0.000 |
| local-transit:station-to-assembler:belt:iron-plate | iron-plate | local-transit | station-to-assembler.belt | 0.045 | 2.000 | 0.000 |
| local-transit:station-to-assembler:loading:iron-plate | iron-plate | local-transit | station-to-assembler.loading | 0.037 | 1.000 | 0.000 |
| local-transit:station-to-assembler:unloading:iron-plate | iron-plate | local-transit | station-to-assembler.unloading | 0.037 | 1.000 | 0.000 |
