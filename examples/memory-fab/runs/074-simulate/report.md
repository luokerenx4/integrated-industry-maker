# INM Run 074-simulate

- Decision: **BASELINE**
- Blueprint: `generated-dram-fab`
- Score: **28.748**
- Result hash: `ed517cff1b9a6df0a038f203d7060a9404b83e6fcf06b05420d5cf935b825780`
...
- Lot service: 91.7% on time · mean cycle 63.373 s · p95 81.956 s · mean tardiness 0.118 s
...
- Inventory accounting: 21.793 average scored WIP / 119.146 total inventory · 55.000 peak WIP / 171.000 peak total
...
| known-good-dram-die | WIP | 8.822 | 27.000 | 0.000 |
| patterned-cell-l1-lot | WIP | 0.145 | 2.000 | 0.000 |
| qualified-dram-wafer-lot | WIP | 0.125 | 2.000 | 0.000 |
...
| dram-wafer-lot | WIP | 0.080 | 2.000 | 0.000 |
...
| dram-package-substrate | excluded | 40.362 | 93.000 | 0.000 |
...
```json
{
  ...
  "qualityEscapes": 0,
  "rework": -1,
  "tardiness": -0.007844444444444446,
  "throughput": 0,
  "wip": -32.69
}
```
