...
- Inventory accounting: 49.457 average / 88.000 peak `dram-device-equivalent` · 27.834 average / 59.000 peak raw WIP items · 124.730 average / 180.000 peak total raw items
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| packaged-dram-device | WIP ×1 | 15.153 | 34.000 | 8.000 | 15.153 | 34.000 | 8.000 |
| known-good-dram-die | WIP ×1 | 9.593 | 28.000 | 0.000 | 9.593 | 28.000 | 0.000 |
| qualified-dram-wafer-lot | WIP ×8 | 0.507 | 2.000 | 0.000 | 4.054 | 16.000 | 0.000 |
| annealed-dielectric-stack-lot | WIP ×8 | 0.411 | 2.000 | 0.000 | 3.291 | 16.000 | 0.000 |
...
| patterned-cell-l2-lot | WIP ×8 | 0.357 | 2.000 | 0.000 | 2.858 | 16.000 | 0.000 |
...
| dram-package-substrate | excluded | 40.029 | 93.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| tool-qualification-wafer | excluded | 11.127 | 16.000 | 8.000 | 0.000 | 0.000 | 0.000 |
| chamber-clean-kit | excluded | 10.860 | 16.000 | 8.000 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| buffer:burn-in-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-1.package-input | ×1 | 9.781 | 28.000 | 8.000 | 9.781 | 28.000 | 8.000 |
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 7.966 | 25.000 | 0.000 | 7.966 | 25.000 | 0.000 |
...
| in-process:etch-l2:etch-cell-layer-2:patterned-cell-l2-lot | patterned-cell-l2-lot | in-process | etch-l2.etch-cell-layer-2 | ×8 | 0.250 | 1.000 | 0.000 | 2.000 | 8.000 | 0.000 |
...
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 0.483 | 7.000 | 0.000 | 0.483 | 7.000 | 0.000 |
...
| buffer:etch-l2:pattern-input:patterned-cell-l2-lot | patterned-cell-l2-lot | buffer | etch-l2.pattern-input | ×8 | 0.047 | 1.000 | 0.000 | 0.378 | 8.000 | 0.000 |
...
| buffer:lithography-l2:reentrant-input:annealed-dielectric-stack-lot | annealed-dielectric-stack-lot | buffer | lithography-l2.reentrant-input | ×8 | 0.031 | 1.000 | 0.000 | 0.251 | 8.000 | 0.000 |
...
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.233 | 2.000 | 0.000 | 0.233 | 2.000 | 0.000 |
...
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.169 | 1.000 | 0.000 | 0.169 | 1.000 | 0.000 |
...
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.142 | 1.000 | 0.000 | 0.142 | 1.000 | 0.000 |
