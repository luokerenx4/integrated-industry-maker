# INM Run 098-simulate

- Decision: **BASELINE**
- Blueprint: `generated-dram-fab`
- Score: **-1.271**
- Result hash: `7bcc176c6e6a5aa422332c9f5f47411349d3c2cce191b0332f13dee836ce7bc0`
...
- Release flow: 6.000 s planned interval · 8.966 s actual interval · 13.812 s mean / 62.623 s maximum delay · 0 pending
- Release control: conwip · max WIP 6 · reopen at 5 · earliest-due-date · peak 6 active lots · 6 control-blocked / 165.738 lot-s · 0 capacity-blocked / 0.000 lot-s · 0 service openings / 0 protected releases
- Lot service: 100.0% on time · mean cycle 60.863 s · p95 74.456 s · mean tardiness 0.000 s
...
- Inventory accounting: 49.291 average / 88.000 peak `dram-device-equivalent` · 27.989 average / 59.000 peak raw WIP items · 124.434 average / 180.000 peak total raw items
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| probe-to-packaging | 24.000 / 240.000 | 10.0% | 50000 | 29100 | 14800 | 6100 | 0 | 96 known-good-dram-die |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| packaged-dram-device | WIP ×1 | 15.186 | 34.000 | 8.000 | 15.186 | 34.000 | 8.000 |
| known-good-dram-die | WIP ×1 | 9.760 | 29.000 | 0.000 | 9.760 | 29.000 | 0.000 |
| qualified-dram-wafer-lot | WIP ×8 | 0.507 | 2.000 | 0.000 | 4.054 | 16.000 | 0.000 |
| annealed-dielectric-stack-lot | WIP ×8 | 0.416 | 2.000 | 0.000 | 3.325 | 16.000 | 0.000 |
...
| patterned-cell-l2-lot | WIP ×8 | 0.307 | 2.000 | 0.000 | 2.458 | 16.000 | 0.000 |
| dram-wafer-lot | WIP ×8 | 0.285 | 2.000 | 0.000 | 2.279 | 16.000 | 0.000 |
| rework-required-dram-wafer-lot | WIP ×8 | 0.043 | 1.000 | 0.000 | 0.347 | 8.000 | 0.000 |
| dram-package-substrate | excluded | 39.629 | 92.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| tool-qualification-wafer | excluded | 11.102 | 16.000 | 8.000 | 0.000 | 0.000 | 0.000 |
| chamber-clean-kit | excluded | 10.835 | 16.000 | 8.000 | 0.000 | 0.000 | 0.000 |
...
| commercial-dram-device | excluded | 0.542 | 8.000 | 0.000 | 0.000 | 0.000 | 0.000 |
| performance-dram-device | excluded | 0.281 | 4.000 | 0.000 | 0.000 | 0.000 | 0.000 |
| automotive-dram-device | excluded | 0.056 | 2.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| buffer:burn-in-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-1.package-input | ×1 | 9.815 | 28.000 | 8.000 | 9.815 | 28.000 | 8.000 |
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 8.118 | 26.000 | 0.000 | 8.118 | 26.000 | 0.000 |
...
| buffer:probe-1:wafer-input:qualified-dram-wafer-lot | qualified-dram-wafer-lot | buffer | probe-1.wafer-input | ×8 | 0.072 | 1.000 | 0.000 | 0.574 | 8.000 | 0.000 |
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 0.498 | 7.000 | 0.000 | 0.498 | 7.000 | 0.000 |
...
| buffer:lithography-l2:reentrant-input:annealed-dielectric-stack-lot | annealed-dielectric-stack-lot | buffer | lithography-l2.reentrant-input | ×8 | 0.036 | 1.000 | 0.000 | 0.285 | 8.000 | 0.000 |
| local-transit:lithography-to-etch-lithography-l2:belt:patterned-cell-l2-lot | patterned-cell-l2-lot | local-transit | lithography-to-etch-lithography-l2.belt | ×8 | 0.035 | 1.000 | 0.000 | 0.280 | 8.000 | 0.000 |
...
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.242 | 2.000 | 0.000 | 0.242 | 2.000 | 0.000 |
...
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.155 | 1.000 | 0.000 | 0.155 | 1.000 | 0.000 |
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.147 | 1.000 | 0.000 | 0.147 | 1.000 | 0.000 |
| local-transit:rework-to-inspection:belt:dram-wafer-lot | dram-wafer-lot | local-transit | rework-to-inspection.belt | ×8 | 0.018 | 1.000 | 0.000 | 0.140 | 8.000 | 0.000 |
| local-transit:packaging-to-burn-in:unloading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.unloading | ×1 | 0.107 | 1.000 | 0.000 | 0.107 | 1.000 | 0.000 |
| local-transit:packaging-to-burn-in:loading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.loading | ×1 | 0.104 | 1.000 | 0.000 | 0.104 | 1.000 | 0.000 |
...
| local-transit:lithography-to-etch-lithography-l2:loading:patterned-cell-l2-lot | patterned-cell-l2-lot | local-transit | lithography-to-etch-lithography-l2.loading | ×8 | 0.013 | 1.000 | 0.000 | 0.100 | 8.000 | 0.000 |
| local-transit:lithography-to-etch-lithography-l2:unloading:patterned-cell-l2-lot | patterned-cell-l2-lot | local-transit | lithography-to-etch-lithography-l2.unloading | ×8 | 0.013 | 1.000 | 0.000 | 0.100 | 8.000 | 0.000 |
...
| buffer:inspection-1:wafer-input:dram-wafer-lot | dram-wafer-lot | buffer | inspection-1.wafer-input | ×8 | 0.011 | 1.000 | 0.000 | 0.086 | 8.000 | 0.000 |
...
| local-transit:inspection-to-rework:belt:rework-required-dram-wafer-lot | rework-required-dram-wafer-lot | local-transit | inspection-to-rework.belt | ×8 | 0.006 | 1.000 | 0.000 | 0.047 | 8.000 | 0.000 |
...
```json
{
  ...
  "changeovers": -2.5,
  "constraintPenalty": 0,
  "cycleTime": -2.028752777777778,
  "deliveryValue": 86,
  "electricityCost": 0,
  "energy": -2.0586556049999998,
  "occupiedArea": -14.25,
  "onTimeDelivery": 20,
  "qualityEscapes": 0,
  "rework": -1,
