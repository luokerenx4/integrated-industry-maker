# INM Run 099-simulate

- Decision: **BASELINE**
- Blueprint: `generated-dram-fab`
- Score: **-0.463**
- Result hash: `c43d94a6594744869e1ec25784b08689eb74eafa8ce9fac8e8ced0c17f6206da`
...
- Inventory accounting: 49.291 average / 88.000 peak `dram-device-equivalent` · 27.989 average / 59.000 peak raw WIP items · 125.101 average / 180.000 peak total raw items
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| probe-to-packaging | 24.000 / 240.000 | 10.0% | 107500 | 68300 | 30900 | 8300 | 0 | 96 known-good-dram-die |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| packaged-dram-device | WIP ×1 | 14.832 | 33.000 | 8.000 | 14.832 | 33.000 | 8.000 |
| known-good-dram-die | WIP ×1 | 10.113 | 30.000 | 0.000 | 10.113 | 30.000 | 0.000 |
...
| dram-package-substrate | excluded | 39.983 | 92.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| buffer:burn-in-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-1.package-input | ×1 | 9.446 | 27.000 | 8.000 | 9.446 | 27.000 | 8.000 |
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 6.849 | 27.000 | 0.000 | 6.849 | 27.000 | 0.000 |
...
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 1.813 | 20.000 | 0.000 | 1.813 | 20.000 | 0.000 |
...
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.399 | 2.000 | 0.000 | 0.399 | 2.000 | 0.000 |
...
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.229 | 1.000 | 0.000 | 0.229 | 1.000 | 0.000 |
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.223 | 1.000 | 0.000 | 0.223 | 1.000 | 0.000 |
...
```json
{
  ...
  "electricityCost": 0,
  "energy": -2.0588533275,
  "occupiedArea": -13.450000000000001,
  "onTimeDelivery": 20,
  "qualityEscapes": 0,
  "rework": -1,
  "tardiness": 0,
