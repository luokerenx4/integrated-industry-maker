# INM Run 100-simulate

- Decision: **BASELINE**
- Blueprint: `generated-dram-fab`
- Score: **-0.307**
- Result hash: `5302c842062cb8f5785dff1387f89a26439f3b510ca86126b621ac3fca013a06`
...
- Lot service: 100.0% on time · mean cycle 60.432 s · p95 73.856 s · mean tardiness 0.000 s
...
- Inventory accounting: 49.191 average / 88.000 peak `dram-device-equivalent` · 28.039 average / 59.000 peak raw WIP items · 124.882 average / 180.000 peak total raw items
...
- Capacity plan: READY
- Belt utilization: 1.4%
- Average blocked belt items: 0.872
- Peak belt items: 8
...
- Aggregate unpowered time: 624193 device-ticks
- Feasible: yes
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| probe-to-packaging | 24.000 / 240.000 | 10.0% | 108900 | 69100 | 31300 | 8500 | 0 | 96 known-good-dram-die |
...
| known-good-dram-die | WIP ×1 | 10.165 | 30.000 | 0.000 | 10.165 | 30.000 | 0.000 |
| qualified-dram-wafer-lot | WIP ×8 | 0.513 | 2.000 | 0.000 | 4.101 | 16.000 | 0.000 |
...
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 6.874 | 27.000 | 0.000 | 6.874 | 27.000 | 0.000 |
...
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 1.832 | 20.000 | 0.000 | 1.832 | 20.000 | 0.000 |
...
| buffer:probe-1:wafer-input:qualified-dram-wafer-lot | qualified-dram-wafer-lot | buffer | probe-1.wafer-input | ×8 | 0.078 | 1.000 | 0.000 | 0.621 | 8.000 | 0.000 |
...
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.403 | 2.000 | 0.000 | 0.403 | 2.000 | 0.000 |
...
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.231 | 1.000 | 0.000 | 0.231 | 1.000 | 0.000 |
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.225 | 1.000 | 0.000 | 0.225 | 1.000 | 0.000 |
