# INM Run 106-candidate-trial-parallel-burn-in-overflow

- Decision: **TRIAL**
- Candidate: `parallel-burn-in-overflow`
- Candidate proposal: `5b43f0820696400f2d60ca093c6faf3f4d01ce6e45dec3adc94d7a3c3f572f13`
- Locked review: **DISCARD** · `66d35a80d2b14f585ea44df35bc449e18a4fc3f5343eb2127516bb33d3ebd96c`
- Blueprint: `generated-dram-fab`
- Score: **-1000040.089**
- Result hash: `9d2680cc170cc4ea756ce8c0fe20cbb1ff86eaefce68303026c5d3c40f89eb42`
- Bottleneck: packaging-1
- Throughput/min: 16.000
- Delivery portfolio: 128.0% demand attainment · 64.000 / 50.000 valued / demanded · 14.000 above demand · 67.000 net value/min
  - Contract `commercial-order`: 34.000 / 32.000 `commercial-dram-device` · 106.3% · 68.000 net value
...
- Source-lot lineage: 12 source lots · 96 created · 64 delivered · 0 discarded · 32 final WIP · 4 commingled jobs
...
- Equipment setup: 9 changeovers · 43.000 s work · 0 campaign holds / 0.000 s (0 lot-ready / 0 timeout)
- Equipment energy states: 0 sleeps · 0 wakeups · 0.000 equipment-s sleeping · 0.000 equipment-s waking
- Inventory accounting: 59.530 average / 96.000 peak `dram-device-equivalent` · 38.379 average / 72.000 peak raw WIP items · 134.085 average / 181.000 peak total raw items
...
- Average blocked belt items: 0.955
- Peak belt items: 8
- Powered transport energy: 5549.275 J
- High-speed carrier missions: 0
- Carrier missions / completed returns: 0 / 0
- Material treated: none
- Treatment agents consumed: none
- Aggregate unpowered time: 1772599 device-ticks
- Infeasible: build cost 245310 exceeds 230000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| probe-to-packaging | 24.000 / 240.000 | 10.0% | 188200 | 123200 | 34500 | 30500 | 0 | 96 known-good-dram-die |
| packaging-to-burn-in | 24.000 / 240.000 | 10.0% | 33300 | 7400 | 7600 | 18300 | 0 | 96 packaged-dram-device |
| substrate-receiving-to-packaging | 24.000 / 240.000 | 10.0% | 0 | 0 | 0 | 0 | 0 | 96 dram-package-substrate |
| burn-in-1-dispatch-burn-in-1 | 16.000 / 240.000 | 6.7% | 0 | 0 | 0 | 0 | 0 | 64 packaged-dram-device |
| commercial-to-customer | 8.500 / 240.000 | 3.5% | 7500 | 0 | 7500 | 0 | 0 | 34 commercial-dram-device |
| burn-in-1-dispatch-burn-in-overflow-1 | 8.000 / 240.000 | 3.3% | 100 | 0 | 0 | 100 | 0 | 32 packaged-dram-device |
| performance-to-customer | 5.000 / 240.000 | 2.1% | 0 | 0 | 0 | 0 | 0 | 20 performance-dram-device |
...
| automotive-to-customer-burn-in-overflow-1 | 0.000 / 240.000 | 0.0% | 0 | 0 | 0 | 0 | 0 | — |
| commercial-to-customer-burn-in-overflow-1 | 0.000 / 240.000 | 0.0% | 0 | 0 | 0 | 0 | 0 | — |
| inspection-to-scrap | 0.000 / 240.000 | 0.0% | 0 | 0 | 0 | 0 | 0 | — |
| performance-to-customer-burn-in-overflow-1 | 0.000 / 240.000 | 0.0% | 0 | 0 | 0 | 0 | 0 | — |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| packaged-dram-device | WIP ×1 | 25.545 | 51.000 | 32.000 | 25.545 | 51.000 | 32.000 |
| known-good-dram-die | WIP ×1 | 9.812 | 29.000 | 0.000 | 9.812 | 29.000 | 0.000 |
...
| dram-package-substrate | excluded | 39.389 | 92.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| commercial-dram-device | excluded | 0.286 | 10.000 | 0.000 | 0.000 | 0.000 | 0.000 |
| performance-dram-device | excluded | 0.090 | 4.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| buffer:burn-in-overflow-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-overflow-1.package-input | ×1 | 16.332 | 32.000 | 32.000 | 16.332 | 32.000 | 32.000 |
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 5.639 | 20.000 | 0.000 | 5.639 | 20.000 | 0.000 |
...
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 2.388 | 21.000 | 0.000 | 2.388 | 21.000 | 0.000 |
| buffer:burn-in-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-1.package-input | ×1 | 2.167 | 13.000 | 0.000 | 2.167 | 13.000 | 0.000 |
...
| buffer:packaging-1:package-output:packaged-dram-device | packaged-dram-device | buffer | packaging-1.package-output | ×1 | 1.945 | 12.000 | 0.000 | 1.945 | 12.000 | 0.000 |
...
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.618 | 2.000 | 0.000 | 0.618 | 2.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:belt:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.belt | ×1 | 0.379 | 3.000 | 0.000 | 0.379 | 3.000 | 0.000 |
| local-transit:packaging-to-burn-in:loading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.loading | ×1 | 0.361 | 1.000 | 0.000 | 0.361 | 1.000 | 0.000 |
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.346 | 1.000 | 0.000 | 0.346 | 1.000 | 0.000 |
...
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.222 | 1.000 | 0.000 | 0.222 | 1.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:unloading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.unloading | ×1 | 0.163 | 1.000 | 0.000 | 0.163 | 1.000 | 0.000 |
...
| local-transit:burn-in-1-dispatch-burn-in-1:loading:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-1.loading | ×1 | 0.067 | 1.000 | 0.000 | 0.067 | 1.000 | 0.000 |
| local-transit:burn-in-1-dispatch-burn-in-1:unloading:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-1.unloading | ×1 | 0.067 | 1.000 | 0.000 | 0.067 | 1.000 | 0.000 |
| local-transit:burn-in-1-dispatch-burn-in-1:belt:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-1.belt | ×1 | 0.053 | 1.000 | 0.000 | 0.053 | 1.000 | 0.000 |
...
| local-transit:burn-in-1-dispatch-burn-in-overflow-1:belt:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-overflow-1.belt | ×1 | 0.040 | 1.000 | 0.000 | 0.040 | 1.000 | 0.000 |
| local-transit:burn-in-1-dispatch-burn-in-overflow-1:unloading:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-overflow-1.unloading | ×1 | 0.035 | 1.000 | 0.000 | 0.035 | 1.000 | 0.000 |
| local-transit:burn-in-1-dispatch-burn-in-overflow-1:loading:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-overflow-1.loading | ×1 | 0.033 | 1.000 | 0.000 | 0.033 | 1.000 | 0.000 |
| buffer:burn-in-1-dispatcher:storage:packaged-dram-device | packaged-dram-device | buffer | burn-in-1-dispatcher.storage | ×1 | 0.029 | 1.000 | 0.000 | 0.029 | 1.000 | 0.000 |
...
| --- | --- | --- | --- | ---: |
| dram-lot-01 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-02 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-03 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-04 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-05 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-06 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-10 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
| dram-lot-12 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 4 |
...
{
  "blocked": 0,
  "buildCost": -12.265500000000001,
  "changeovers": -4.5,
  "constraintPenalty": -1000000,
  "cycleTime": -2.0143944444444446,
  "deliveryValue": 67,
  "electricityCost": 0,
  "energy": -2.063858825,
  "occupiedArea": -15.950000000000001,
  "onTimeDelivery": 20,
  "qualityEscapes": 0,
  "rework": -1,
  "tardiness": 0,
