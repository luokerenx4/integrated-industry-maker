# INM Run 107-candidate-trial-batch-coherent-burn-in-overflow

- Decision: **TRIAL**
- Candidate: `batch-coherent-burn-in-overflow`
- Candidate proposal: `df8fdd6d0280f050cfd11b9edc9ee710aee2859c39150cc8038c1c0d9f610067`
- Locked review: **DISCARD** · `ff72f2cb0a9e3fb8893ce613bbb72957ebe775d2c23f5323c3c06345c80fcd7e`
- Blueprint: `generated-dram-fab`
- Score: **-1000039.162**
- Result hash: `e9c615495570004b240f40cb1b4fde593a5a3ab2e950e9125940d69b92963a2f`
...
- Source-lot lineage: 12 source lots · 96 created · 64 delivered · 0 discarded · 32 final WIP · 0 commingled jobs
...
- Inventory accounting: 58.912 average / 88.000 peak `dram-device-equivalent` · 37.760 average / 72.000 peak raw WIP items · 133.463 average / 180.000 peak total raw items
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| probe-to-packaging | 24.000 / 240.000 | 10.0% | 150300 | 97700 | 24700 | 27900 | 0 | 96 known-good-dram-die |
| packaging-to-burn-in | 24.000 / 240.000 | 10.0% | 71300 | 0 | 500 | 70800 | 0 | 96 packaged-dram-device |
...
| commercial-to-customer | 8.500 / 240.000 | 3.5% | 0 | 0 | 0 | 0 | 0 | 34 commercial-dram-device |
| burn-in-1-dispatch-burn-in-overflow-1 | 8.000 / 240.000 | 3.3% | 0 | 0 | 0 | 0 | 0 | 32 packaged-dram-device |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| packaged-dram-device | WIP ×1 | 24.837 | 49.000 | 32.000 | 24.837 | 49.000 | 32.000 |
| known-good-dram-die | WIP ×1 | 9.902 | 29.000 | 0.000 | 9.902 | 29.000 | 0.000 |
...
| dram-package-substrate | excluded | 39.479 | 92.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| commercial-dram-device | excluded | 0.192 | 8.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| buffer:burn-in-overflow-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-overflow-1.package-input | ×1 | 14.259 | 32.000 | 32.000 | 14.259 | 32.000 | 32.000 |
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 6.287 | 21.000 | 0.000 | 6.287 | 21.000 | 0.000 |
...
| buffer:burn-in-1-dispatcher:storage:packaged-dram-device | packaged-dram-device | buffer | burn-in-1-dispatcher.storage | ×1 | 2.627 | 7.000 | 0.000 | 2.627 | 7.000 | 0.000 |
...
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 2.031 | 13.000 | 0.000 | 2.031 | 13.000 | 0.000 |
...
| buffer:packaging-1:package-output:packaged-dram-device | packaged-dram-device | buffer | packaging-1.package-output | ×1 | 1.924 | 12.000 | 0.000 | 1.924 | 12.000 | 0.000 |
...
| buffer:burn-in-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-1.package-input | ×1 | 0.850 | 8.000 | 0.000 | 0.850 | 8.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:belt:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.belt | ×1 | 0.537 | 3.000 | 0.000 | 0.537 | 3.000 | 0.000 |
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.515 | 2.000 | 0.000 | 0.515 | 2.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:loading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.loading | ×1 | 0.337 | 1.000 | 0.000 | 0.337 | 1.000 | 0.000 |
...
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.291 | 1.000 | 0.000 | 0.291 | 1.000 | 0.000 |
...
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.178 | 1.000 | 0.000 | 0.178 | 1.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:unloading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.unloading | ×1 | 0.135 | 1.000 | 0.000 | 0.135 | 1.000 | 0.000 |
...
| local-transit:burn-in-1-dispatch-burn-in-overflow-1:belt:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-overflow-1.belt | ×1 | 0.040 | 2.000 | 0.000 | 0.040 | 2.000 | 0.000 |
...
| local-transit:burn-in-1-dispatch-burn-in-overflow-1:unloading:packaged-dram-device | packaged-dram-device | local-transit | burn-in-1-dispatch-burn-in-overflow-1.unloading | ×1 | 0.033 | 1.000 | 0.000 | 0.033 | 1.000 | 0.000 |
...
| --- | --- | --- | --- | ---: |
| dram-lot-02 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 8 |
| dram-lot-05 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 8 |
| dram-lot-06 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 8 |
| dram-lot-12 | packaged-dram-device | buffer | burn-in-overflow-1.package-input | 8 |
