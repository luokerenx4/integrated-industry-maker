# INM Run 116-candidate-trial-run-114-prioritized-four-die-tra

- Decision: **TRIAL**
- Candidate: `run-114-prioritized-four-die-tray`
- Candidate proposal: `45f9ddb0971ca8163f7df3c30e8df4a4f9e2e32676ede5e9fd9ce834c84daa30`
- Locked review: **KEEP** · `86bcb3ec67ecc1d9862fd25b9109ed745324b7e7abe5170fc75389aa54d38a30`
- Blueprint: `generated-dram-fab`
- Score: **1.259**
- Result hash: `5cd38f0024db8d0ae8fd0555ff6a757c23b8a456e0f7ab4ad8f2bf03c45a08fb`
...
- Inventory accounting: 49.191 average / 88.000 peak `dram-device-equivalent` · 28.331 average / 59.000 peak raw WIP items · 125.138 average / 180.000 peak total raw items
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| packaging-to-burn-in | 24.000 / 240.000 | 10.0% | 1400 | 0 | 800 | 600 | 0 | 96 packaged-dram-device |
| substrate-receiving-to-packaging | 24.000 / 240.000 | 10.0% | 0 | 0 | 0 | 0 | 0 | 96 dram-package-substrate |
| commercial-to-customer | 13.000 / 240.000 | 5.4% | 1200 | 0 | 600 | 600 | 0 | 52 commercial-dram-device |
| performance-to-customer | 6.000 / 240.000 | 2.5% | 114050 | 75150 | 1500 | 37400 | 0 | 24 performance-dram-device |
| probe-to-packaging | 24.000 / 960.000 | 2.5% | 0 | 0 | 0 | 0 | 0 | 96 known-good-dram-die |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| packaged-dram-device | WIP ×1 | 15.206 | 34.000 | 8.000 | 15.206 | 34.000 | 8.000 |
| known-good-dram-die | WIP ×1 | 10.145 | 30.000 | 0.000 | 10.145 | 30.000 | 0.000 |
...
| performance-dram-device | excluded | 1.151 | 12.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| commercial-dram-device | excluded | 0.314 | 8.000 | 0.000 | 0.000 | 0.000 | 0.000 |
| automotive-dram-device | excluded | 0.045 | 2.000 | 0.000 | 0.000 | 0.000 | 0.000 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| buffer:burn-in-1:package-input:packaged-dram-device | packaged-dram-device | buffer | burn-in-1.package-input | ×1 | 9.736 | 28.000 | 8.000 | 9.736 | 28.000 | 8.000 |
| buffer:packaging-1:die-input:known-good-dram-die | known-good-dram-die | buffer | packaging-1.die-input | ×1 | 9.215 | 28.000 | 0.000 | 9.215 | 28.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:belt:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.belt | ×1 | 0.166 | 2.000 | 0.000 | 0.166 | 2.000 | 0.000 |
...
| local-transit:packaging-to-burn-in:unloading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.unloading | ×1 | 0.151 | 1.000 | 0.000 | 0.151 | 1.000 | 0.000 |
| local-transit:packaging-to-burn-in:loading:packaged-dram-device | packaged-dram-device | local-transit | packaging-to-burn-in.loading | ×1 | 0.146 | 1.000 | 0.000 | 0.146 | 1.000 | 0.000 |
...
| local-transit:probe-to-packaging:loading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.loading | ×1 | 0.100 | 4.000 | 0.000 | 0.100 | 4.000 | 0.000 |
| local-transit:probe-to-packaging:unloading:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.unloading | ×1 | 0.100 | 4.000 | 0.000 | 0.100 | 4.000 | 0.000 |
...
| local-transit:probe-to-packaging:belt:known-good-dram-die | known-good-dram-die | local-transit | probe-to-packaging.belt | ×1 | 0.080 | 4.000 | 0.000 | 0.080 | 4.000 | 0.000 |
| buffer:probe-1:die-output:known-good-dram-die | known-good-dram-die | buffer | probe-1.die-output | ×1 | 0.050 | 4.000 | 0.000 | 0.050 | 4.000 | 0.000 |
...
| buffer:packaging-1:package-output:packaged-dram-device | packaged-dram-device | buffer | packaging-1.package-output | ×1 | 0.006 | 1.000 | 0.000 | 0.006 | 1.000 | 0.000 |
