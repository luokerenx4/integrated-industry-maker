...
const COMMANDS: Omit<CliCommandDescriptor, "exitCodes">[] = [
  ...
  {
    id: "investigate",
    usage: "inm investigate <path> [--investigation ID [--create | --entry ID | --create-candidate ID | --create-production-plan ID]] [options] [--json]",
    ...
    arguments: [
      ...
      { name: "target-diagnostic-anchor", form: "option", value: "string", required: false, description: "Explicit cited diagnostic-bearing evidence anchor whose current diagnostic this decision dispositions." },
      ...
      { name: "capture-comparison", form: "option", value: "string", required: false, description: "Introduce an exact recomputable immutable Run comparison under this anchor id; requires --from-run and --to-run." },
      { name: "from-run", form: "option", value: "string", required: false, description: "Baseline immutable Run captured by --capture-comparison." },
      { name: "to-run", form: "option", value: "string", required: false, description: "Result immutable Run captured by --capture-comparison; becomes the cited operating context." },
      ...
      { name: "create-production-plan", form: "option", value: "string", required: false, description: "Create one source-pinned Production Plan revision with this id from the current exact hypothesis." },
      { name: "hypothesis-entry", form: "option", value: "string", required: false, description: "Exact hypothesis entry used by Candidate or Production Plan authoring." },
      { name: "benchmark", form: "option", value: "string", required: false, description: "Locked Benchmark used by --create-candidate." },
      { name: "candidate-name", form: "option", value: "string", required: false, description: "Display name used by --create-candidate." },
      { name: "patch-file", form: "option", value: "string", required: false, description: "JSON file containing the caller-authored RFC 6902 patch used by --create-candidate." },
      { name: "production-plan-file", form: "option", value: "string", required: false, description: "JSON file containing the complete caller-authored Production Plan used by --create-production-plan." },
