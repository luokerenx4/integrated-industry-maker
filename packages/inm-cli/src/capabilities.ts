...
const COMMANDS: Omit<CliCommandDescriptor, "exitCodes">[] = [
  ...
  {
    id: "design", usage: "inm design <path> [--program ID] [--run | --run-id HASH [--promote ID]] [--max-candidates N] [--progress MODE] [--json]", description: "Discover, inspect, execute, reopen, or promote a bounded project-local Design Program.",
    effect: "mode-dependent", supportsJson: true, arguments: [path, project,
