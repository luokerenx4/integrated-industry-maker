...
export const blueprintSchema = z.object({
    ...
    policy: z.object({
      ...
      cadenceControl: z.discriminatedUnion("kind", [
        z.object({
          ...
          minimumCoverageDeficitTicks: positiveInt,
        }).strict(),
        z.object({
          kind: z.literal("input-queue-recovery"),
          process: id,
          normalMode: id,
          recoveryMode: id,
          inputResource: id,
          recoverAtItems: positiveInt,
          minimumQueueTicks: positiveInt,
        }).strict(),
      ]).optional(),
  ...
  policies: z.object({
    ...
    lotRelease: z.object({
      ...
      serviceLevelAfterTicks: nonNegativeInt.optional(),
