...
interface DeviceCatalogAsset {
  ...
  production?: {
    categories: string[]; speed: { numerator: number; denominator: number }; inputPorts: string[]; outputPorts: string[];
    modes: Array<{
...
interface IndustrialAnalysis {
  ...
  stationNetworks: Array<{
    network: string; kind: "local" | "inter-zone"; dispatchPolicy: "fifo" | "round-robin" | "shortage-first"; fleetAsset: string; fleetSize: number; stations: number; estimatedCarrierLoad: number;
    ...
    routes: Array<{
      ...
      minimumBatch: number; carrierBatchCapacity: number; batchCapacity: number; standardTravelTicks: number; standardMissionEnergyMilliJoules: number; travelTicks: number; missionEnergyMilliJoules: number; highSpeed: { enabled: boolean; travelTicks: number; missionEnergyMilliJoules: number } | null; capacityItemsPerMinute: number; energyLimitedItemsPerMinute: number;
