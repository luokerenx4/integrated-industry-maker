...
interface Device {
  ...
  toolingProvider?: { serviceRadius: number; inventoryBuffer: string };
  capabilities: string[];
  ...
  return <section className="scene-inspector" aria-label={`Device inspector: ${device.id}`}>
    ...
    <div className="scene-inspector-scroll">
      ...
      <div className="inspector-facts">
        ...
        {device.toolingProvider && <span><small>TOOLING SERVICE</small><b>{device.toolingProvider.serviceRadius} RANGE · INVENTORY {device.toolingProvider.inventoryBuffer}</b></span>}
        ...
        <article className="asset-detail">
          {selected && <>
            ...
            {selected.type === "device" ? <>
              ...
              {selected.toolingProvider && <section className="asset-section"><h4>Reusable tooling provider</h4><div className="asset-table"><div><b>FINITE SHARED TOOL INVENTORY</b><strong>service radius {selected.toolingProvider.serviceRadius}</strong><span>reserved for the complete production job</span><code>inventory @ {selected.toolingProvider.inventoryBuffer}</code></div></div></section>}
