...
test("Studio exposes the same memory-fab Design Program, immutable run, and guarded promotion contract", async () => {
  ...
  try {
    ...
    expect(designCatalog.programs).toEqual([
        expect.objectContaining({ id: "back-end-die-handoff", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "transport-blocking" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 1 } }),
        ...
        expect.objectContaining({ id: "burn-in-changeover-convergence", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "setup-campaign" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 1 } }),
        ...
        expect.objectContaining({ id: "front-end-queue-convergence", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "queue-congestion" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 5 } }),
        ...
        expect.objectContaining({ id: "layer-two-dimensional-control", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "yield-quality" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0.02 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 1 } }),
        expect.objectContaining({ id: "layer-two-particle-control", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "yield-quality" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 2 } }),
        expect.objectContaining({ id: "lithography-maintenance-convergence", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "maintenance-qualification" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 2 } }),
        expect.objectContaining({ id: "release-admission-convergence", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "release-admission" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 2 } }),
        expect.objectContaining({ id: "shipping-power-convergence", locked: true, seed: { kind: "blueprint", blueprint: "generated-dram-fab" }, focus: expect.objectContaining({ kind: "loss", loss: "power-interruption" }), currentBestGuardrail: { kind: "uniform", maximumCaseScoreRegression: 0 }, frontier: { maximumAlternativeBranches: 0 }, budget: { maxCandidates: 2 } }),
    ]);
