...
- 2026-07-30 — Follow-up [[plans/verified-candidate-design-lineage]] replaces that temporary replay requirement with strict commissioned authority from the original Run, Candidate, KEEP receipt, and current Blueprint; `6f1f260672f1…` is removed as redundant evidence.
