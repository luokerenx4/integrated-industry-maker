...
- Manual in-app Studio verification confirms the same leader and alternative cards, two explicit `BRANCH` decisions, all six parent lineages, and no visible error. Full regression remains pending.
